...
public class activity_intent_implicit extends AppCompatActivity {
    Intent intent = null;
    EditText input_location, input_web, input_dial, input_share_text;
    ImageView image_selected_view, image_camera_view;

    private static final String TAG = activity_intent_implicit.class.getCanonicalName();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if (requestCode == CAMERA_REQUEST && resultCode == activity_intent_implicit.RESULT_OK){
